...
Como nuestros datos no siguen una distribución normal como vimos en la primera parte de la práctica, no podremos aplicarlo a nuestros datos, es por ello que solamente vamos a aplicarlo de manera manual con unos datos que cumplen las condiciones necesarias
...
# Mostramos la importancia de variables
