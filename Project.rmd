...
***ver relaciones entre variables tmb viendo scatter plots, si no vemos relacion tomar logs***
...
Podemos ver como, a priori, el salario anual no influye en la decisión de abandonar el banco
Vamos a comprobarlo con un contraste de hipótesis: 
...
if (p_value < alpha) {
  ...
  print("No podemos rechazar la hipótesis nula. No existe ninguna diferencia significativa entre los grupos")
}
```
